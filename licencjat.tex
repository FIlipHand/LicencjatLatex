...
\end{center} 
Pozornie nic się nie zmieniło, jednak teraz przeprowadzamy gradient przez $z$, które jest teraz deterministycznie. W poprzednim przypadku było ono losowe wybierane z dystrybucji. \\
\begin{figure}[h!]
	\centering
	\begin{tikzpicture}
