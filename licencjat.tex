...
\end{center}
Mnożąc $q(z|x)$ przez nawias, otrzymujemy sumę od całką, co możemy zapisać jako sumę dwóch całek. Następnie wartość $\log p(x)$ możemy wyłączyć przed całkę, ponieważ całkując po $z$ traktujemy ten logarytm jako stałą.
\begin{center}
