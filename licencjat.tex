...
\end{center} 
Pozornie nic się nie zmieniło, jednak teraz przeprowadzamy gradient przez $z$, idąc od dekodera do enkodera, które jest teraz deterministycznie, co widać na grafice \ref{sztuczka} \cite{cokolwiek}. W poprzednim przypadku było ono losowe wybierane z dystrybucji. \\
\begin{figure}[h!]
	\centering
	\begin{tikzpicture}
